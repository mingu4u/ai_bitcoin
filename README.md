...
## 시스템 아키텍처
![image](https://github.com/user-attachments/assets/dfeb2642-3b30-4411-8683-6759eb5b3a6a)
...
* **자가 학습**: 지속적인 전략 개선을 위한 성찰 모델 구현 (최근 3일간의 트레이딩 퍼포먼스 분석) 
...
1. 저장소 복제
   ```bash
   git clone https://github.com/mingu4u/ai_bitcoin.git
   cd ai_bitcoin
   ```
